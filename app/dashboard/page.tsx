                ...
                <p className="text-gray-400 mb-4">No organizations found</p>
                  ...
                  <div className="space-y-4">
                    {allOrganizations.map((org, index) => (
                      <div key={org.id || index} className="border border-gray-700 rounded-lg p-4 bg-gray-800">
                ...
                <p className="text-gray-400 mb-4">No active users found</p>
                  ...
                  <div className="space-y-4">
                    {activeUsers.map((user, index) => (
                      <div key={user.user_id || index} className="border border-gray-700 rounded-lg p-4 bg-gray-800">
                        <div className="flex justify-between items-start">
                          <div className="flex-1">
                            <h3 className="font-medium text-white">

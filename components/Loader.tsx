  ...
  return (
    <div className="flex flex-col items-center justify-center text-center p-8">
      <div className="relative flex items-center justify-center">
        <div className="absolute h-24 w-24 rounded-full border-t-4 border-b-4 border-cyan-400 animate-spin"></div>
        <div className="absolute h-16 w-16 rounded-full border-l-4 border-r-4 border-fuchsia-500 animate-[spin_1.2s_linear_infinite_reverse]"></div>
      ...
      <p className="mt-6 text-lg font-medium text-slate-300 tracking-wider animate-pulse">{message}</p>
    </div>
  );
};

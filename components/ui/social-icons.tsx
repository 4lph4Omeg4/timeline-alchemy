...
export const SocialIcon: React.FC<SocialIconProps> = ({ platform, size = 'md', className = '' }) => {
  const sizeClasses = {
    sm: 'w-6 h-6',
    md: 'w-8 h-8',
    lg: 'w-12 h-12'
  ...
  switch (platform.toLowerCase()) {
    ...
    default:
      return (
        <div className={`${iconClasses} bg-gray-500 rounded flex items-center justify-center`}>
